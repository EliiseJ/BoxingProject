...
public class SOAPService {
    ...
    public Competition getCompetition(@WebParam(name = "id") long id, @WebParam(name = "token") String token) {
        return boxingService.getCompetition(id, token);
    }
    
    @WebMethod(operationName = "AddCompetition")
    public void addCompetiton(@WebParam(name = "newCompetition") NewCompetition newCompetition, @WebParam(name = "token") String token) {
        boxingService.addCompetiton(newCompetition, token);
    }
    
    @WebMethod(operationName = "GetFighterById")
    public Fighter getFighter(@WebParam(name = "id") long id, @WebParam(name = "token") String token) {
    ...
    public void addFighter(@WebParam(name = "newFighter") NewFighter newFighter, @WebParam(name = "token") String token) {
        boxingService.addFighter(newFighter, token);
    }
    
    @WebMethod(operationName = "GetCompetitionList")
    public List<Competition> getCompetitionList(@WebParam(name = "token") String token) {
        return boxingService.getCompetitionList(token);
    }
    
    @WebMethod(operationName = "GetFighterList")
    public List<Fighter> getFighterList(@WebParam(name = "token") String token) {
        return boxingService.getFighterList(token);
    }
    
    @WebMethod(operationName = "AddCompetitionFighter")
    public void addCompetitionFighter(@WebParam(name = "fighterId") long fighterId, @WebParam(name = "competitionId") long competitionId, @WebParam(name = "token") String token) {
        boxingService.addCompetitionFighter(fighterId, competitionId, token);
    }
    
    @WebMethod(operationName = "GetCompetitionFighters")
    public List<Fighter> getCompetitionFighters(@WebParam(name = "id") long id, @WebParam(name = "token") String token) {
